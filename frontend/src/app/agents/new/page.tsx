          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <SearchableSelect
                ...
                options={getModelsForProvider(identityProfile.provider)}
                placeholder={identityProfile.provider ? "Select a model" : "Select a provider first"}
                ...
                disabled={isLoading || !identityProfile.provider}
              />
            </div>
          </div>
        </div>
